...
from src.offchain.contract_interaction import fill_order
...
def test(
    ...
    mint_free(name=wallet_a, token_name=token_a, amount=42)
    mint_free(name=wallet_b, token_name=token_b, amount=81)
    mint_license(
